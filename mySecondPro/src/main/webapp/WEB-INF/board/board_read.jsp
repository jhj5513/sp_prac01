 ...
 -->
   ...
   <tr>
	...
	<tr>
		...
		<hr size=1>
		<div align="center">
		[ <input type="button" value="목록" onclick="move('board_list.do');"> | 
		<input type="button" value="수정" onclick="move('board_modify.do');"> |
		<!-- <input type="button" value="답변" onclick="move('board');"> | -->
		<input type="button" value="삭제" onclick="move('board_delete.do');">]<br>
		</div>
		</td>
	</tr>
	</table>
